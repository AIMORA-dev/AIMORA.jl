...
export PowerSemiconductorSwitch,
       ...
       SeriesRCSnubber,
       RecoveredChargeFidelity,
       NonlinearJunctionChargeFidelity,
       TurnOffTailFidelity,
       SwitchingEnergyTable,
       CauerThermalFidelity,
       DeclaredSemiconductorModelIdentity,
       PowerSemiconductorExtendedFidelity,
       PowerSemiconductorExtendedState,
       PowerSemiconductorTerminalState,
       power_semiconductor_has_extended_fidelity,
       power_semiconductor_extended_state,
       power_semiconductor_junction_capacitance,
       power_semiconductor_junction_charge,
       power_semiconductor_junction_stored_energy,
       initialize_power_semiconductor_junction_state!,
       power_semiconductor_switching_energy,
       power_semiconductor_thermal_stored_energy,
       accept_power_semiconductor_thermal_step!,
       ...
       block_power_semiconductor_bridge!,
       restart_power_semiconductor_bridge!,
